...
def test_unify_campaign_dates():
    ...
    expected_start = [pd.to_datetime("2023-01-01").date()] * 2 + [pd.to_datetime("2023-02-01").date()] * 3
    expected_end = [pd.to_datetime("2023-01-10").date()] * 2 + [pd.to_datetime("2023-02-10").date()] * 3
