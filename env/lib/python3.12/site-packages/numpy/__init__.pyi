...
from numpy._typing import (  # Arrays; DTypes; Shapes; Scalars; `number` precision; NOTE: Do not remove the extended precision bit-types even if seemingly unused;; they're used by the mypy plugin; Character codes; Ufuncs
    ...
    _80Bit, _96Bit, _128Bit, _256Bit, _ArrayLike, _ArrayLikeBool_co,
    ...
    _DT64Codes, _DTypeLike, _DTypeLikeVoid, _FlexibleCodes, _Float16Codes,
    _Float32Codes, _Float64Codes, _FloatingCodes, _FloatLike_co, _GenericCodes,
    _GUFunc_Nin2_Nout1, _HalfCodes, _InexactCodes, _Int8Codes, _Int16Codes,
    _Int32Codes, _Int64Codes, _IntCCodes, _IntegerCodes, _IntLike_co,
    _IntPCodes, _LongCodes, _LongDoubleCodes, _LongLongCodes, _NBitByte,
    _NBitDouble, _NBitHalf, _NBitIntC, _NBitIntP, _NBitLong, _NBitLongDouble,
    _NBitLongLong, _NBitShort, _NBitSingle, _NestedSequence, _NumberCodes,
    _NumberLike_co, _ObjectCodes, _ScalarLike_co, _Shape, _ShapeLike,
    _ShortCodes, _SignedIntegerCodes, _SingleCodes, _StrCodes, _StringCodes,
    _SupportsArray, _TD64Codes, _TD64Like_co, _UByteCodes, _UFunc_Nin1_Nout1,
    _UFunc_Nin1_Nout2, _UFunc_Nin2_Nout1, _UFunc_Nin2_Nout2, _UInt8Codes,
    _UInt16Codes, _UInt32Codes, _UInt64Codes, _UIntCCodes, _UIntPCodes,
    _ULongCodes, _ULongLongCodes, _UnsignedIntegerCodes, _UShortCodes,
...
from numpy._typing._callable import (_BoolBitOp, _BoolDivMod, _BoolMod,
                                     ...
                                     _ComparisonOpGE, _ComparisonOpGT,
                                     _ComparisonOpLE, _ComparisonOpLT,
                                     _FloatDivMod, _FloatMod, _FloatOp,
                                     _IntTrueDiv, _NumberOp, _SignedIntBitOp,
                                     _SignedIntDivMod, _SignedIntMod,
                                     _SignedIntOp, _UnsignedIntBitOp,
                                     _UnsignedIntDivMod, _UnsignedIntMod,
                                     _UnsignedIntOp)
# NOTE: Numpy's mypy plugin is used for removing the types unavailable
# to the specific platform
from numpy._typing._extended_precision import (complex160, complex192,
                                               complex256, complex512, float80,
                                               float96, float128, float256,
                                               int128, int256, uint128,
                                               uint256)
...
from typing import (NoReturn, SupportsComplex, SupportsFloat, SupportsIndex,
                    SupportsInt, TypeAlias, TypedDict, final, type_check_only)
...
from _typeshed import (StrOrBytesPath, SupportsFlush, SupportsLenAndGetItem,
                       SupportsWrite)
...
from typing_extensions import (CapsuleType, LiteralString, Never, Protocol,
                               Self, TypeVar, Unpack, deprecated, overload)
...
from numpy._core._ufunc_config import (_ErrCall, _ErrKind, getbufsize, geterr,
...
from numpy.lib._arraysetops_impl import (ediff1d, in1d, intersect1d, isin,
                                         setdiff1d, setxor1d, union1d, unique,
                                         unique_all, unique_counts,
                                         unique_inverse, unique_values)
from numpy.lib._function_base_impl import (angle, append, asarray_chkfinite,
                                           average, bartlett, bincount,
                                           blackman, copy, corrcoef, cov,
                                           delete, diff, digitize, extract,
                                           flip, gradient, hamming, hanning,
                                           i0, insert, interp, iterable,
                                           kaiser, median, meshgrid,
                                           percentile, piecewise, place,
                                           quantile, rot90, select, sinc,
                                           sort_complex, trapezoid, trapz,
                                           trim_zeros, unwrap)
...
from numpy.lib._nanfunctions_impl import (nanargmax, nanargmin, nancumprod,
                                          ...
                                          nanvar)
from numpy.lib._npyio_impl import (fromregex, genfromtxt, load, loadtxt,
...
from numpy.lib._polynomial_impl import (poly, polyadd, polyder, polydiv,
                                        ...
                                        polyval, roots)
from numpy.lib._shape_base_impl import (apply_along_axis, apply_over_axes,
