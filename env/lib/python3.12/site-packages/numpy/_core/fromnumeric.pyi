...
from typing import (Any, Literal, Protocol, SupportsIndex, TypeAlias, TypeVar,
                    overload, type_check_only)

import numpy as np
from _typeshed import Incomplete
from numpy import (_AnyShapeType, _CastingKind, _ModeKind, _OrderACF,
                   _OrderKACF, _PartitionKind, _SortKind, _SortSide,
                   complexfloating, float16, floating, generic, int64, int_,
                   intp, number, object_, timedelta64, uint64)
