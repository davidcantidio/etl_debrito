...
from typing import (Protocol, SupportsIndex, TypeAlias, TypedDict, TypeVar,
                    final, overload, type_check_only)

import numpy as np
from _typeshed import StrOrBytesPath, SupportsLenAndGetItem
from numpy import (_AnyShapeType, _CastingKind, _CopyMode, _ModeKind,
                   ...
                   datetime64, dtype)
from numpy import \
    einsum as c_einsum  # type: ignore[attr-defined]; Re-exports; The rest
...
from numpy._typing import (ArrayLike, DTypeLike,  # Shapes; DTypes; Arrays
                           ...
                           _ShapeLike, _SupportsArrayFunc, _SupportsDType,
                           _TD64Like_co)
