...
from typing import (NoReturn, SupportsAbs, SupportsIndex, TypeAlias, TypeGuard,
                    TypeVar, overload)

import numpy as np
from numpy import (False_, True_, _AnyShapeType, _OrderCF,  # re-exports; other
                   _OrderKACF, bitwise_not, broadcast, complexfloating, dtype,
                   flatiter, float64, floating, from_dlpack, generic, inf,
                   int_, intp, little_endian, matmul, nan, ndarray, nditer,
                   newaxis, object_, signedinteger, timedelta64, ufunc,
                   unsignedinteger, vecdot)
from numpy._typing import (ArrayLike, DTypeLike, NDArray, _ArrayLike,
                           ...
                           _NestedSequence, _ScalarLike_co, _ShapeLike,
...
from .multiarray import (_Array, _ConstructorEmpty,  # re-exports; other
                         _KwargsEmpty, arange, array, asanyarray, asarray,
                         ascontiguousarray, asfortranarray, can_cast,
                         concatenate, copyto, dot, empty, empty_like,
                         frombuffer, fromfile, fromiter, fromstring, inner,
                         lexsort, may_share_memory, min_scalar_type,
                         nested_iters, promote_types, putmask, result_type,
