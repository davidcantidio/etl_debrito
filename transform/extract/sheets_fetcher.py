...
from transform.transform.utils.get_google_client import \
...
class SheetsFetcher:
    ...
    def _fetch_and_cache(self, sheet_names: List[str]) -> Dict[str, List[List[str]]]:
        ...
        """
        from transform.transform.utils.sheet_name_normalizer import batch_normalize_sheet_names, safe_sheet_range
