...
class BaseETL:
    def __init__(
        ...
        id_veiculo: int,
        veiculo: str,
        mapping_id_campanha: dict = None,
        mapping_nome_campanha: dict = None,
        cache_estados: dict = None,
        cache_municipios: dict = None,
    ):
        self.df = df.copy()
        self.mapping_id_campanha = mapping_id_campanha or {}
        self.mapping_nome_campanha = mapping_nome_campanha or {}
    ...
    def aplicar_parametrizacao_campanha_externa(self):
        ...
        self.df['ID_Campanha'] = self.df[col_campaign].apply(lambda x: buscar_mapping(self.mapping_id_campanha, x))
        self.df['Campanha'] = self.df[col_campaign].apply(lambda x: buscar_mapping(self.mapping_nome_campanha, x) or x)
